...
const ShapeGrid: React.FC<ShapeGridProps> = ({
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // We remove the default hardcoded radial gradient from the canvas logic here,
      // and prefer transparency, so it integrates flawlessly with the brutalist CSS background.
      // (Originally generated by user snippet, but background should be transparent to show the big DHRUMIL AMIN text underneath)
    };
